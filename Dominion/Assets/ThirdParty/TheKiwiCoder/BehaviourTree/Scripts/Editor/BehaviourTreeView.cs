...
namespace TheKiwiCoder {
    public class BehaviourTreeView : GraphView {
        ...
        public ScriptTemplate[] scriptFileAssets = {
            ...
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateConditionalNode, defaultFileName="NewConditionalNode.cs", subFolder="Conditionals" },
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
            ...
            evt.menu.AppendAction($"Create Script.../New Conditional Node", (a) => CreateNewScript(scriptFileAssets[2]));
